...
console.log('¿Está vacío el tanque del conche ', ibiza.modelo, ibiza.estaDepositoVacio());
console.log('¿Está vacío el tanque del conche ', astra.modelo, astra.estaDepositoVacio());
